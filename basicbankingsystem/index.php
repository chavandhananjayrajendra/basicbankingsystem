...
<body>
    ...
    <div class="fullpage">
        ...
        <div class="tag"><strong>WELCOME TO  SPARKS FOUNDATION</strong></div>
        </marquee>
...
<!-- Copyright -->
<div class="footer-copyright text-center py-3"style="padding-inline:40%;background-color:pink; font-color:violet;">©2023 Copyright:
  <a href="index.php">sparksfoundation.com</a>
  <h3>Sparks Foundation</h3>
            <p>Mumbai</p>
            <h3>Contact information:</h3>
            <p>Mail Address: <a href="mailto:xyz@example.com">sparks123@gmail.com</a></p>
            <p>Postal Address: <i>N.G.Bansode Marg,Worli,Mumbai</i></p>
            <p>Tel. No. <i>7715047459</i></p>
</div>
<!-- Copyright -->
