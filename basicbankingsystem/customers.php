...
<a style="margin:auto;width:50%;padding:550px;font-size:70px; font-weight: bold;color:black;">Customers</a>
...
?>
        <table class="table" style="margin-top: 80px;font-size:15px;color:black; ">
            <thead  >
                <tr>
