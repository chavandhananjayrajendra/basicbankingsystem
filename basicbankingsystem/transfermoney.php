    ...
    <center>
        <div class="container" style="margin-top:2%; ">
            <div
                ...
                <h1 style=" color:violet;font-size:30px; ">Transfer Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px; font-size:20px; ">
                <form action="transfermoney.php" method="post">
                    ...
                    <p style="color:yellow;font-size:30px; ">Want to check your balance? check <a href="checkbalance.php">click here</a></p>
                </form>
            </div>
        </div>
